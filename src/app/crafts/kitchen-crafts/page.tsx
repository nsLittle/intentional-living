...
export default function kitchenCraftsPage() {
  ...
  const kitchenCrafts = allCrafts
    .filter((c) => c.tags.includes("kitchen-crafts"))
    .sort((a, b) => {
  ...
  return (
    <>
      <HeaderNavBarServer />
      <Header />
      <LayoutAllCrafts heading="Kitchen Crafts" crafts={kitchenCrafts} />
      <Footer />
    </>
  );
}
