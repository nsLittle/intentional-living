...
export default function otherCraftsPage() {
  ...
  const otherCrafts = allCrafts
    .filter((c) => c.tags.includes("other-crafts"))
    .sort((a, b) => {
  ...
  return (
    <>
      <HeaderNavBarServer />
      <Header />
      <LayoutAllCrafts heading="Other Crafts" crafts={otherCrafts} />
      <Footer />
    </>
  );
}
