// src/app/printables/field-notes/page.tsx
import HeaderNavBarServer from "components/HeaderNavBarServer";
import Header from "components/Header";
import Footer from "components/Footer";
import Image from "next/image";
import Link from "next/link";
import { getPrintablesByCategory } from "lib/printables";
...
export default function PrintablesFieldNotesPage() {
  const all = getPrintablesByCategory("field-notes");
    ...
    <>
      ...
      <main className="mx-auto max-w-5xl px-6 pb-16">
        {items.length ? (
          ...
          <p className="text-gray-600">No field note printables yet.</p>
        )}
      </main>
...
<p className="mt-3 text-center text-[#5c5045]/80">
  Download ready-to-print field note cards and foraging guides.
</p>;
