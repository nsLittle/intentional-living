// src/app/printables/projects/page.tsx
...
export default function PrintablesProjectsPage() {
  const all = getAllPrintables().filter((p) => p.category === "projects");
      ...
      <div className="bg-white text-black">
        <div className="max-w-5xl mx-auto px-6 py-12">
          <h1 className="font-serif text-[#5c5045] text-4xl font-bold text-center">
            Printable Projects Patterns
          </h1>
          <p className="mt-3 text-center text-[#5c5045]/80">
            Knitting/craft patterns and project helpers to print at home.
          </p>
        </div>
      </div>
