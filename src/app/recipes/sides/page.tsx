...
export default function SidesRecipesPage() {
  ...
  const sidesRecipes = allRecipes
    .filter((r) => r.tags.includes("sides"))
    .sort((a, b) => {
  ...
  return (
    <>
      <HeaderNavBarServer />
      <Header />
      <LayoutAllRecipes heading="Other Recipes" recipes={sidesRecipes} />
      <Footer />
    </>
  );
}
