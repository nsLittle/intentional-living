// src/components/LayoutAllForagedRecipe.tsx
...
type AllForagedRecipeLayoutProps = {
  title: string;
  date: string;
  hero?: string;
  parentPost?: string;
...
export default function LayoutAllForagedRecipe({
  title,
  date,
  hero,
  parentPost,
    ...
    <div className="bg-[#fefcf9] min-h-screen text-[#5c5045] font-serif">
      ...
      <div className="w-full bg-[#fefcf9] px-6 py-12 flex flex-col items-center">
        <article className="w-full max-w-3xl">
          ...
          {/* Download + Print — AllForagedRecipe PDF & Tag (2×2 grid) */}
            ...
            {pdf && (
              <>
                ...
                <ButtonDownloadPdf
                  ...
                  label="Download AllForagedRecipe"
